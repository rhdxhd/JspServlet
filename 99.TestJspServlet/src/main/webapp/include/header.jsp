...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">TSERVLET</a>
			<p text align="letf">
			<button	class="font-weight-bold bg-primary text-white rounded" type="button">조회</button>
			<font size="1">
			<a class="navbar-brand" href="#page-top">추가</a>
			<a class="navbar-brand" href="#page-top">수정</a>
			<a class="navbar-brand" href="#page-top">삭제</a>
