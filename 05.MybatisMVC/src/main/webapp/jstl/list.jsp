...
<section class="page-section">
	<div class="container">
		<h1>JSTL 연습</h1>
		<p>JSP 개발을 좀 더 편하고 단순화 하기 위한 태그 libarary(JSP Standard Tag Library)
		</p>
		...
		<p>
			fmt이용 그루핑 사용:
			<fmt:formatNumber value="${number}" groupingUsed="true" />
		</p>
		<p>
			fmt이용 그루핑 사용:
		...
		<p>
			fmt이용 패턴:
			<fmt:formatNumber value="${number}" pattern="#,##0원" />
		</p>
		<p>
			fmt이용 금액1:
		...
		<p>
			fmt이용 금액2:
			<fmt:formatNumber value="0.163" type="percent" />
		</p>
		<p>
			fmt이용 금액2:
			<fmt:formatNumber value="0.163" pattern="0.00%" />
		</p>
