...
public class Ex01_Request extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//URN: htt......Ex01_Request?param=값
		//RequestDispatcher : 요청객체(request)로 초기화가 되며, 요청에 대한 처리를 다시 페이지로 넘길껀지, 처리결과를 얻어 오는 등
		//여러가지 기능을 수행함.
		...
		System.out.println("요청 정보(URI):" + request.getRequestURI()); //식별자
